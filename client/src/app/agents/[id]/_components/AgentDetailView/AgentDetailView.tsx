/* AgentDetailView — the /agents/:id screen body: left agent list + right Config
   editor (model + system prompt). Tab state lives in ?tab=. Extracted from the
   route so `page.tsx` can be a thin Server Component that owns metadata; this
   view stays a Client Component (data hooks, router, search params). */
"use client";
